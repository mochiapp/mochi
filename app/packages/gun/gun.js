;(function () {
  ...
  ;USE(function (module) {
    ...
    Type.fns = Type.fn = {is: function (fn) { return (!!fn && typeof fn === 'function') }}
  ...
  USE(function (module) {
    ...
    function soul (msg, ev) {
      var as = this.as, cat = as.at; as = as.as
      // ev.stun(); // TODO: BUG!?
  ...
  USE(function (module) {
    ...
    Gun.on('create', function (root) {
      ...
      if (opt.localStorage === false) { return ev.next(root) }
      ...
      var flush = function () {
        ...
        to = false
        try {
          store.setItem('gap/' + opt.file, JSON.stringify(gap))
